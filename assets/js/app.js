    ...
    "engineer-chiiki": {
      tables: [{
        rows: [
          ...
          { label: "給与", value: [
            "初任給",
            "学部卒　基本給○○円＋地域手当（2026年4月実績）",
            "院卒　　基本給○○円＋地域手当（2026年4月実績）",
            "※地域手当",
    ...
    "chiiki-hokkaido": {
      tables: [{
        rows: [
          ...
          { label: "給与", value: [
            "初任給",
            "学部卒　基本給○○円＋地域手当5,000円（2026年4月実績）",
            "短大卒　基本給○○円＋地域手当5,000円（2026年4月実績）",
            "※その他手当あり。"
          ]},
          { label: "諸手当", value: "扶養手当、通勤費、家賃補助（広域コースのみ）　他" }
        ].concat(COMMON_ROWS_TAIL, [
      ...
      tables: [
        {
          rows: [
            ...
            { label: "給与", value: [
              "初任給",
              "一都三県（つくば含む）勤務の場合",
              "学部卒　基本給○○円＋地域手当15,000円（2026年4月実績）",
              "短大卒　基本給○○円＋地域手当15,000円（2026年4月実績）",
